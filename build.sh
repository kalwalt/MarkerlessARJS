...
EM_MRKARJS_FLAGS="-msse -msse2 -msse3 -mssse3 -I$OURDIR/emscripten/depends/opencv-em -I$OURDIR/emscripten/depends/build_opencv-em -I$OURDIR/emscripten/depends/opencv_contrib/modules/xfeatures2d/include -I$OURDIR/emscripten/depends/opencv-em/include -I$OURDIR/emscripten/depends/opencv-em/modules/core/include -I$OURDIR/emscripten/depends/opencv-em/modules/highgui/include -I$OURDIR/emscripten/depends/opencv-em/modules/imgcodecs/include -I$OURDIR/emscripten/depends/opencv-em/modules/videoio/include -I$OURDIR/emscripten/depends/opencv-em/modules/imgproc/include -I$OURDIR/emscripten/depends/opencv-em/modules/calib3d/include -I$OURDIR/emscripten/depends/opencv-em/modules/features2d/include -I$OURDIR/emscripten/depends/opencv-em/modules/flann/include -I$OURDIR/emscripten/depends/opencv-em/modules/video/include -I$OURDIR/emscripten -I$OURDIR/emscripten/include -I$OURDIR/emscripten/depends/opencv-em/build_opencv_em_ui"
